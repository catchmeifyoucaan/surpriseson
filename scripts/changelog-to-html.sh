...
if [[ -z "$version_content" ]]; then
  echo "<h2>Surprisebot $VERSION</h2>"
  echo "<p>Latest Surprisebot update.</p>"
  echo "<p><a href=\"https://github.com/surprisebot/surprisebot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
