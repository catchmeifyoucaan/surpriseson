...
- Same path: run the app from a fixed location (for Surprisebot, `dist/Surprisebot.app`).
...
```bash
sudo tccutil reset Accessibility com.surprisebot.mac
sudo tccutil reset ScreenCapture com.surprisebot.mac
