...
read_when:
  ...
  - Wiring external systems into Surprisebot
---
...
- `surprisebot hooks gmail setup` writes `hooks.gmail` config for `surprisebot hooks gmail run`.
