...
Surprisebot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.surprisebot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["surprisebot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
