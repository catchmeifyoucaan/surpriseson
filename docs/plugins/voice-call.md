...
read_when:
  - You want to place an outbound voice call from Surprisebot
  - You are configuring or developing the voice-call plugin
---

# Voice Call (plugin)

Voice calls for Surprisebot via a plugin. Supports outbound notifications and
...
- Use `surprisebot voicecall ...` or the `voice_call` tool
...
```bash
surprisebot plugins install ./extensions/voice-call
