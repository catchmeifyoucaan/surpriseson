---
summary: "Use MiniMax M2.1 in Surprisebot"
read_when:
  - You want MiniMax models in Surprisebot
...
Configure manually via `surprisebot.json`:
...
## Configure via `surprisebot configure`

Use the interactive config wizard to set MiniMax without editing JSON:

1) Run `surprisebot configure`.
2) Select **Model/auth**.
...
- Use `surprisebot models list` and `surprisebot models set minimax/MiniMax-M2.1` to switch.
...
- Running `surprisebot configure` and selecting **MiniMax M2.1**, or
