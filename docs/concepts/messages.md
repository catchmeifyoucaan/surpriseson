...
This page ties together how Surprisebot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Surprisebot keeps a
...
Surprisebot separates the **prompt body** from the **command body**:
...
Surprisebot can expose or hide model reasoning:
