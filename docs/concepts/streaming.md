...
Surprisebot has two separate “streaming” layers:
...
When block streaming is enabled, Surprisebot can **merge consecutive block chunks**
...
When draft streaming is active, Surprisebot disables block streaming for that reply to avoid double-streaming.
