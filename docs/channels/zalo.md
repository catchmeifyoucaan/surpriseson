...
- Install via CLI: `surprisebot plugins install @surprisebot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `surprisebot plugins install ./extensions/zalo`
   - From npm (if published): `surprisebot plugins install @surprisebot/zalo`
...
- Approve via:
  - `surprisebot pairing list zalo`
  - `surprisebot pairing approve zalo <CODE>`
...
- Example: `surprisebot message send --channel zalo --to 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `surprisebot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `surprisebot logs --follow`
