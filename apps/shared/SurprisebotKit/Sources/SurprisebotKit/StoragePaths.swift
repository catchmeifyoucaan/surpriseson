...
public enum SurprisebotNodeStorage {
    public static func appSupportDir() throws -> URL {
        let base = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first
        guard let base else {
            throw NSError(domain: "SurprisebotNodeStorage", code: 1, userInfo: [
    ...
    public static func cachesDir() throws -> URL {
        ...
        guard let base else {
            throw NSError(domain: "SurprisebotNodeStorage", code: 2, userInfo: [
