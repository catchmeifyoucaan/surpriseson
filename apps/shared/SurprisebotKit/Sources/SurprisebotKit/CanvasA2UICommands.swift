...
public enum SurprisebotCanvasA2UICommand: String, Codable, Sendable {
...
public struct SurprisebotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SurprisebotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
