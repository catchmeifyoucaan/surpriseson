...
@MainActor
struct SurprisebotChatComposer: View {
    @Bindable var viewModel: SurprisebotChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(SurprisebotChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(SurprisebotChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \SurprisebotPendingAttachment.id)
                { (att: SurprisebotPendingAttachment) in
                    HStack(spacing: 6) {
    ...
    private var editor: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Rectangle()
                .fill(SurprisebotChatTheme.divider)
                .frame(height: 1)
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(SurprisebotChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(SurprisebotChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(SurprisebotChatTheme.subtleCard)
        .clipShape(Capsule())
    }
