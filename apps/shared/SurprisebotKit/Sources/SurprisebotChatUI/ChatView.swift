...
@MainActor
public struct SurprisebotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SurprisebotChatViewModel
    ...
    public init(
        viewModel: SurprisebotChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                SurprisebotChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [SurprisebotChatMessage] {
        let base: [SurprisebotChatMessage]
    ...
    private func mergeToolResults(in messages: [SurprisebotChatMessage]) -> [SurprisebotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SurprisebotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SurprisebotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SurprisebotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SurprisebotChatMessage) -> String {
