...
public typealias SurprisebotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SurprisebotPlatformImage = UIImage
#endif

public struct SurprisebotChatUsageCost: Codable, Hashable, Sendable {
...
public struct SurprisebotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SurprisebotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SurprisebotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SurprisebotChatMessageContent: Codable, Hashable, Sendable {
...
public struct SurprisebotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SurprisebotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SurprisebotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SurprisebotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SurprisebotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SurprisebotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SurprisebotChatMessageContent].self, forKey: .content) {
...
public struct SurprisebotChatHistoryPayload: Codable, Sendable {
...
public struct SurprisebotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SurprisebotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SurprisebotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SurprisebotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SurprisebotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SurprisebotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SurprisebotPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: SurprisebotPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct SurprisebotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
