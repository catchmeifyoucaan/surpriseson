...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.surprisebot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Surprisebot windows, but below the system’s pop-up menus.
