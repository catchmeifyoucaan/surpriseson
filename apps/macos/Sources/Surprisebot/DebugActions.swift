...
enum DebugActions {
    private static let verboseDefaultsKey = "surprisebot.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "surprisebot.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Surprisebot", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".surprisebot/surprisebot.json")
        guard
