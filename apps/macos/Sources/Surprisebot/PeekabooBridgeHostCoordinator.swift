...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.surprisebot", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: SurprisebotPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = SurprisebotPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.surprisebotSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.surprisebotSocketPath, privacy: .public)")
    }
...
@MainActor
private final class SurprisebotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.surprisebot.peekaboo")
