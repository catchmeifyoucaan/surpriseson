...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.surprisebot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.surprisebot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SurprisebotChatMessage] = messages.compactMap { item in
