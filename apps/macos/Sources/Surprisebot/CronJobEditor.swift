...
struct CronJobEditor: View {
    ...
    static let introText =
        "Create a schedule that wakes surprisebot via the Gateway. "
    ...
    static let sessionTargetNote =
        ...
        + "Isolated jobs run surprisebot in a dedicated session and can deliver results (WhatsApp/Telegram/Discord/etc)."
        ...
        VStack(alignment: .leading, spacing: 10) {
            Grid(alignment: .leadingFirstTextBaseline, horizontalSpacing: 14, verticalSpacing: 10) {
                GridRow {
                    ...
                    TextField("What should surprisebot do?", text: self.$agentMessage, axis: .vertical)
                        .textFieldStyle(.roundedBorder)
                        .lineLimit(3...7)
                        .frame(maxWidth: .infinity)
                }
