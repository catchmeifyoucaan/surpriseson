...
enum SurprisebotConfigFile {
    private static let logger = Logger(subsystem: "com.surprisebot", category: "config")

    static func url() -> URL {
        SurprisebotPaths.configURL
    }

    static func stateDirURL() -> URL {
        SurprisebotPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SurprisebotPaths.workspaceURL
    }
