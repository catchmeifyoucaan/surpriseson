...
final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    ...
    func userContentController(_: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        let text = SurprisebotCanvasA2UIAction.formatAgentMessage(messageContext)
        ...
        Task { [weak webView] in
            ...
            await MainActor.run {
                ...
                let js = SurprisebotCanvasA2UIAction.jsDispatchA2UIActionStatus(
                    actionId: actionId,
                    ok: result.ok,
                    error: result.error)
    ...
    // Formatting helpers live in SurprisebotKit (`SurprisebotCanvasA2UIAction`).
}
