...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .surprisebotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SurprisebotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SurprisebotPaths.stateDirURL.path
...
extension Notification.Name {
    static let surprisebotSelectSettingsTab = Notification.Name("surprisebotSelectSettingsTab")
}
