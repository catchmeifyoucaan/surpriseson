...
final class ScreenRecordService {
    ...
    private let logger = Logger(subsystem: "com.surprisebot", category: "screenRecord")
        ...
        outPath: String?) async throws -> (path: String, hasAudio: Bool)
    {
        ...
        let outURL: URL = {
            ...
            return FileManager.default.temporaryDirectory
                .appendingPathComponent("surprisebot-screen-record-\(UUID().uuidString).mp4")
        }()
...
private final class StreamRecorder: NSObject, SCStreamOutput, SCStreamDelegate, @unchecked Sendable {
    let queue = DispatchQueue(label: "com.surprisebot.screenRecord.writer")
