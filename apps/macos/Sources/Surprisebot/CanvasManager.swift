...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.surprisebot", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Surprisebot/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__surprisebot__/a2ui/").absoluteString + "?platform=macos"
    }
