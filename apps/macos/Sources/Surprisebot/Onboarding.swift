...
enum UIStrings {
    static let welcomeTitle = "Welcome to Surprisebot"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "surprisebot.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SurprisebotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SurprisebotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g surprisebot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SurprisebotChatViewModel(
