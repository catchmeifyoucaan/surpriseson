...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Surprisebot token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: SurprisebotOAuthStore.AnthropicOAuthStatus = SurprisebotOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "com.surprisebot", category: "anthropic-oauth")
...
enum SurprisebotOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let surprisebotOAuthDirEnv = "SURPRISEBOT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Surprisebot OAuth token file not found"
            case .unreadableFile: "Surprisebot OAuth token file not readable"
            case .invalidJSON: "Surprisebot OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Surprisebot OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Surprisebot OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.surprisebotOAuthDirEnv]?
