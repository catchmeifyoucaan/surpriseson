...
public struct CanvasShowResult: Codable, Sendable {
    /// Session directory on disk (e.g. `~/Library/Application Support/Surprisebot/canvas/<session>/`).
...
public let controlSocketPath =
    ...
    .appendingPathComponent("Library/Application Support/surprisebot/control.sock")
    .path
