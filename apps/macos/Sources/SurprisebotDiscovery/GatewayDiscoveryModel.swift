...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "com.surprisebot", category: "gateway-discovery")
    ...
    public func start() {
        ...
        for domain in SurprisebotBonjour.bridgeServiceDomains {
            ...
            browser.start(queue: DispatchQueue(label: "com.surprisebot.macos.gateway-discovery.\(domain)"))
        }
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        let domain = SurprisebotBonjour.wideAreaBridgeServiceDomain
    ...
    private func updateGateways(for domain: String) {
        ...
        if domain == SurprisebotBonjour.wideAreaBridgeServiceDomain,
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (Surprisebot)", with: "")
