## Surprisebot Node (Android) (internal)

Modern Android node app: connects to the **Gateway-owned bridge** (`_surprisebot-bridge._tcp`) over TCP and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm surprisebot gateway --port 18789 --verbose
```
