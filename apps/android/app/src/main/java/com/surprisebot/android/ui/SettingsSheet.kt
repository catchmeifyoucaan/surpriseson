...
import com.surprisebot.android.LocationMode
import com.surprisebot.android.MainViewModel
import com.surprisebot.android.NodeForegroundService
import com.surprisebot.android.VoiceWakeMode
  ...
  LazyColumn(
      ...
      AnimatedVisibility(visible = voiceWakeMode != VoiceWakeMode.Off) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
          ListItem(
            ...
            supportingContent = { Text("Listens only while Surprisebot is open.") },
            trailingContent = {
              RadioButton(
    ...
    item {
      Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
        Button(
          onClick = {
            val parsed = com.surprisebot.android.WakeWords.parseCommaSeparated(wakeWordsText)
    ...
    item {
      Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
        ...
        ListItem(
          ...
          supportingContent = { Text("Only while Surprisebot is open.") },
          trailingContent = {
            RadioButton(
    ...
    item {
      ListItem(
        ...
        supportingContent = { Text("Keeps the screen awake while Surprisebot is open.") },
