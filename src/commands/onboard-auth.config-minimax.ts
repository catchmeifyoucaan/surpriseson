...
export function applyMinimaxProviderConfig(cfg: SurprisebotConfig): SurprisebotConfig {
...
export function applyMinimaxConfig(cfg: SurprisebotConfig): SurprisebotConfig {
