...
export function applyOpencodeZenProviderConfig(cfg: SurprisebotConfig): SurprisebotConfig {
...
export function applyOpencodeZenConfig(cfg: SurprisebotConfig): SurprisebotConfig {
