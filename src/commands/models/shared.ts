...
export async function updateConfig(
  mutator: (cfg: SurprisebotConfig) => SurprisebotConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: SurprisebotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: SurprisebotConfig): Set<string> {
