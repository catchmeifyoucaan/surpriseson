...
export const A2UI_PATH = "/__surprisebot__/a2ui";
export const CANVAS_HOST_PATH = "/__surprisebot__/canvas";
export const CANVAS_WS_PATH = "/__surprisebot/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.surprisebotCanvasA2UIAction.postMessage(...)
  // - Android: window.surprisebotCanvasA2UIAction.postMessage(...)
  const actionHandlerName = "surprisebotCanvasA2UIAction";
  ...
  globalThis.Surprisebot = globalThis.Surprisebot ?? {};
  globalThis.Surprisebot.postMessage = postToNode;
  globalThis.Surprisebot.sendUserAction = sendUserAction;
  globalThis.surprisebotPostMessage = postToNode;
  globalThis.surprisebotSendUserAction = sendUserAction;
