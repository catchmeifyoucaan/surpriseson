...
import type { ArtemisConfig } from "./types.artemis.js";
...
import type { MissionControlConfig } from "./types.mission-control.js";
import type { PluginsConfig } from "./types.plugins.js";
import type { SkillsConfig } from "./types.skills.js";
import type { ToolsConfig } from "./types.tools.js";

export type SurprisebotConfig = {
  auth?: AuthConfig;
  env?: {
  ...
  ui?: {
    /** Accent color for Surprisebot UI chrome (hex). */
    seamColor?: string;
  };
  skills?: SkillsConfig;
