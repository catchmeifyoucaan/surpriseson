...
function resolveMentionPatterns(cfg: SurprisebotConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: SurprisebotConfig | undefined, agentId?: string): RegExp[] {
