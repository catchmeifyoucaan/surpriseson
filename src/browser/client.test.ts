...
describe("browser client", () => {
  ...
  it("adds Authorization when SURPRISEBOT_BROWSER_CONTROL_TOKEN is set", async () => {
    const prev = process.env.SURPRISEBOT_BROWSER_CONTROL_TOKEN;
    process.env.SURPRISEBOT_BROWSER_CONTROL_TOKEN = "t1";
    ...
    process.env.SURPRISEBOT_BROWSER_CONTROL_TOKEN = prev;
  });
