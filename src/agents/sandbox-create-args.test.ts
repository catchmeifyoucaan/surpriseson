  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "surprisebot-sbx-test",
        "--label",
        "surprisebot.sandbox=1",
        "--label",
        "surprisebot.sessionKey=main",
        "--label",
        "surprisebot.createdAtMs=1700000000000",
        "--label",
        "surprisebot.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
