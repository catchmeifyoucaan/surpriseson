...
describe("createSurprisebotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    const config: SurprisebotConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createSurprisebotCodingTools({
      config,
    ...
    const anthropicTools = createSurprisebotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createSurprisebotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createSurprisebotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
